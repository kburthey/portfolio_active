...
<!-- Jumbotron -->
	<div class="jumbotron" id="<?php echo $navItems[0]['slug']; ?>">
	  <h1 class="display-3">Kirk Burthey</h1>
	  <p class="lead">Website Developer/Project Manager</p>
	  <hr class="my-4">
	  <p class="lead">
	...
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
	  <div class="carousel-inner" role="listbox">
		<div class="carousel-item active">
		  <a href="Foto/" target="_blank"><img class="d-block img-fluid" src="foto3.png" alt="First slide"></a>
		</div>
	  ...
	  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
		<i class="fa fa-arrow-left" aria-hidden="true" style="color: #867666"></i>
		<span class="sr-only">Previous</span>
	  </a>
	  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
		<i class="fa fa-arrow-right" aria-hidden="true" style="color: #867666"></i>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-12">
				<div class="aboutme" id="aboutmeleft">
					<h4>My name is <span class="name"> Kirk Burthey <span> </h4>
					<p> Born in raised in the south, I am a self taught programmer.
					
					</p>
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
				<div class="aboutme" id="aboutmeright">
				<h3> Languages </h3>
					<div class="row"> 
						<div class="col-md-3">
						<h5> HTML5 </h5>
							<p>test test test test test test</p></div>
						<div class="col-md-3">	
						<h5> CSS3</h5>
							<p></p></div>
						<div class="col-md-3">	
